        ...
        <AnimatePresence mode="wait">
          ...
          {!mode && (
            ...
            >
              ...
              <div className="text-center mb-4 w-full flex flex-col items-center relative z-10 px-6 -translate-y-[20px]">
                {/* 1) Logo +10px */}
                <img
                  src={appLogo}
                  alt="WaitMe!"
                ...
                {/* SUBIDO “AL RAS” */}
                <h1 className="text-4xl font-bold leading-none -mt-[76px] whitespace-nowrap">
