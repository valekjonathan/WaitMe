      ...
      <main className="pt-[56px] pb-20 px-4">
        <Tabs defaultValue="alerts" className="w-full">
          <div className="sticky top-[56px] z-40 bg-black pt-[11px] pb-[2px]">
            <TabsList className="w-full bg-gray-900 border-0 shadow-none ring-0 mt-[2px] mb-[2px]">
              <TabsTrigger value="alerts" className="flex-1 text-white data-[state=active]:bg-purple-600 data-[state=active]:text-white py-[6px]">
                Tus alertas
              </TabsTrigger>
              <TabsTrigger value="reservations" className="flex-1 text-white data-[state=active]:bg-purple-600 data-[state=active]:text-white py-[6px]">
                Tus reservas
              </TabsTrigger>
            </TabsList>
          </div>
  ...
  const dateText = ts ? formatCardDate(ts) : '--';
                ...
                {reservationsFinalAll.filter((item) => !hiddenKeys.has(item.id)).length === 0 ? (
                  <motion.div
                    ...
                    className="bg-gray-900 rounded-xl p-2 border-2 border-gray-700/80 h-[160px] flex items-center justify-center"
                  >
                    <p className="text-gray-500 font-semibold">No tienes reservas finalizadas.</p>
                  </motion.div>
                ) : (
                  <div className="space-y-[20px]">
