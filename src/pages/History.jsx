...
export default function History() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Header UNIFICADO (esto arregla el botón del dinero) */}
        ...
        <Tabs defaultValue="alerts" className="w-full">
          ...
          >
            ...
            {isLoading ? (
              ...
              <>
                {myAlertsItems.filter(i => i.type === 'alert').length > 0 &&
                  myAlertsItems.filter(i => i.type === 'transaction').length > 0 && (
          ...
          >
            ...
            {isLoading ? (
              ...
              <>
                {myReservationsItems.filter(i => i.type === 'alert').length > 0 &&
                  myReservationsItems.filter(i => i.type === 'transaction').length > 0 && (
                    <div className="text-white text-center font-bold py-3 text-sm">
                      Finalizadas:
                    </div>
                  )}
