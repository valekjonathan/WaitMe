    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-16 pb-24 px-4 max-w-md mx-auto">
        ...
        >
          ...
          {/* Créditos */}
          <div className="bg-gradient-to-r from-purple-900/50 to-purple-600/30 rounded-xl p-3 border-2 border-purple-500">
            ...
            <Button className="w-full bg-purple-600 hover:bg-purple-700 h-9 text-sm">
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 divide-y divide-gray-800">
            <Link to={createPageUrl('NotificationSettings')} className="w-full flex items-center gap-3 p-3 text-left hover:bg-gray-800/50 transition-colors">
              <Bell className="w-4 h-4 text-purple-500" />
              <span className="flex-1 text-sm">Notificaciones</span>
              <ChevronRight className="w-4 h-4 text-gray-500" />
            </Link>
            
            <button className="w-full flex items-center gap-3 p-3 text-left hover:bg-gray-800/50 transition-colors">
