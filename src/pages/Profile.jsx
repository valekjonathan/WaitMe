...
import { ArrowLeft, Camera, Car, Truck, Bell, Phone, Save, Settings, MessageCircle, User } from 'lucide-react';
              ...
              <div className="pl-3 flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {formData.vehicle_type === 'van' ? (
                    <Truck className="w-14 h-10" style={{ color: selectedColor?.fill }} />
                  ) : (
