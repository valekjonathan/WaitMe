...
export default function Profile() {
  ...
  // ✅ ICONO GRANDE (arriba a la derecha) CAMBIA EN TIEMPO REAL según vehicle_type
  const VehicleIconProfile = ({ color, size = "w-16 h-10" }) => {
      ...
      case 'van':
        return (
          <svg viewBox="0 0 48 24" className={size} fill="none">
            ...
            <circle cx="14" cy="18" r="1.7" fill="#666" />
            <circle cx="34" cy="18" r="3" fill="#333" stroke="white" strokeWidth="1" />
            <circle cx="34" cy="18" r="1.7" fill="#666" />
          </svg>
        );
      default:
        return (
            ...
            <div className="flex gap-4">
              ...
              <div className="pl-3 flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <VehicleIconProfile color={selectedColor?.fill} />
                </div>
