                ...
                • Te espera hasta las {format(new Date(new Date().getTime() + alert.available_in_minutes * 60000), 'HH:mm', { locale: es })}
                          ...
                          <div className="flex gap-2 w-full">
                            ...
                            <Button
                              variant="ghost"
                              size="icon"
                              className={`flex-1 bg-green-600 hover:bg-green-700 text-white rounded-lg h-8 ${!otherUser.allowCalls ? 'opacity-40 cursor-not-allowed' : ''}`}
                              onClick={() => otherUser.allowCalls && otherUser.phone && (window.location.href = `tel:${otherUser.phone}`)}
