              ...
              <span className="text-purple-400">
                • Te espera hasta las {format(new Date(new Date().getTime() + alert.available_in_minutes * 60000), 'HH:mm', { locale: es })}
                          ...
                          <div className="flex gap-2 w-full">
                            ...
                            <Button
                              size="icon"
                              className={`flex-1 bg-green-600 hover:bg-green-700 text-white rounded-lg h-8 ${!alert?.allow_phone_calls ? 'opacity-40 cursor-not-allowed' : ''}`}
                            ...
                            {alert?.available_in_minutes !== undefined && (
                              <Button
                                className="flex-1 bg-gray-700 hover:bg-gray-600 text-purple-400 rounded-lg h-8 font-bold text-xs"
                                disabled>
