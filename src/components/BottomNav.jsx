...
export default function BottomNav() {
  ...
  const baseBtn =
    ...
    "h-[60px] bg-transparent outline-none border-none rounded-lg";
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-700 px-4 pt-[6px] pb-2 z-50">
      <div className="flex items-center max-w-md mx-auto">
        ...
        <NavLink to={createPageUrl('History')} className="flex-1">
          {({ isActive }) => (
            <div className={`${baseBtn} ${isActive ? activeStyle : ''}`}>
        ...
        <NavLink to={createPageUrl('Home')} className="flex-1">
          {({ isActive }) => (
            <div className={`${baseBtn} ${isActive ? activeStyle : ''}`}>
        ...
        <NavLink to={createPageUrl('Notifications')} className="flex-1">
          {({ isActive }) => (
            <div className={`${baseBtn} ${isActive ? activeStyle : ''}`}>
        ...
        <NavLink to={createPageUrl('Chats')} className="flex-1">
          {({ isActive }) => (
            <div className={`${baseBtn} ${isActive ? activeStyle : ''}`}>
