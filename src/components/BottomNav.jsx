...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-sm border-t-2 border-gray-700 px-4 pt-0 pb-3 safe-area-pb z-50">
      <div className="flex items-center max-w-md mx-auto">
        {/* ALERTAS */}
        <Link to={createPageUrl('History')} className="flex-1 relative">
          <Button variant="ghost" className={baseBtn}>
            <svg viewBox="0 0 32 32" fill="none" className={iconCls}>
