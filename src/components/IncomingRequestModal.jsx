            ...
            <div className="px-3 pb-3">
              <div className="bg-gray-800/60 rounded-xl p-2 border border-purple-500/30">
                ...
                <div className="mt-2 flex justify-between gap-2">
                  ...
                  <Button size="icon" className="flex-1 bg-green-500 hover:bg-green-600 text-white rounded-lg h-8">
                    <MessageCircle className="w-4 h-4"/>
                  </Button>

                  {phoneEnabled?(
                    <Button size="icon" className="flex-1 bg-white hover:bg-gray-200 text-black rounded-lg h-8"
