    ...
    >
      <div className="flex flex-col justify-between flex-1 min-h-0">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <SimplePinDotIcon />
            <span className="leading-none">Ubícate</span>
          </Button>
        </div>

        {/* Tiempo (texto + slider empiezan a la derecha del icono) */}
        <div className="flex gap-2">
          <Clock className="w-[22px] h-[22px] text-purple-400 flex-shrink-0 translate-y-[4px]" />
        ...
        {/* Precio (texto + slider empiezan a la derecha del icono) */}
        <div className="flex gap-2">
          <Euro className="w-[22px] h-[22px] text-purple-400 flex-shrink-0 translate-y-[4px]" />
