        ...
        <div className={dimmed ? 'space-y-1.5 opacity-80' : bright ? 'space-y-1.5' : 'space-y-1.5 opacity-80'}>
          {address ? (
            <div className="flex items-start gap-1.5 text-xs">
              <MapPin className={`w-4 h-4 flex-shrink-0 mt-0.5 ${dimmed ? 'text-purple-500/40' : 'text-purple-300'}`} />
          ...
          {timeLine ? (
            <div className="flex items-start gap-1.5 text-xs">
              <Clock className={`w-4 h-4 flex-shrink-0 mt-0.5 ${dimmed ? 'text-purple-500/40' : 'text-purple-300'}`} />
              {isTimeObj ? (
                <span className={lineTextCls}>
                  <span className="text-white">{timeLine.main}</span>
                  <span className="text-purple-300">{timeLine.accent}</span>
                </span>
              ) : (
                <span className={lineTextCls}>
