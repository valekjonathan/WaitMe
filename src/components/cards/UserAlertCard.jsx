    ...
    <div className="bg-gray-900 rounded-xl p-2 border-2 border-purple-500/50 relative">
      ...
      <div className="mt-2">
        <div className="flex gap-2">
          {/* CHAT (ENCENDIDO/BRILLANTE) */}
          <Button
            size="icon"
            className="bg-[#00E676] hover:bg-[#00D964] text-white rounded-lg h-8 w-[42px] ring-2 ring-[#00E676]/70 shadow-[0_0_26px_rgba(0,230,118,0.95)] hover:shadow-[0_0_30px_rgba(0,230,118,1)] active:scale-[0.98]"
