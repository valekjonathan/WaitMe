...
function defaultState() {
  ...
  const conversations = [
    ...
    },
    {
      ...
      otherUserId: "carlos",
      status: "finalizada",
      finalState: "RECHAZADA",
      lastMessage: "Usuario rechazó tu WaitMe! ❌",
      unread: 0,
      createdAt: baseNow - 40 * 60 * 1000,
      departInMin: 0,
    },
    {
      id: "mock_cancelada_1",
      ...
      otherUserId: "eva",
      status: "finalizada",
      finalState: "CANCELADA",
      lastMessage: "Operación cancelada",
      unread: 0,
      createdAt: baseNow - 50 * 60 * 1000,
      departInMin: 0,
    },
    {
      id: "mock_prorroga_1",
      ...
      status: "finalizada",
      finalState: "PRÓRROGA",
      lastMessage: "Prórroga aceptada (+5 min por 1€)",
      unread: 0,
      createdAt: baseNow - 35 * 60 * 1000,
      departInMin: 0,
    },
    {
      id: "mock_se_fue_1",
      ...
      status: "finalizada",
      finalState: "SE FUE",
      lastMessage: "El usuario se fue antes",
      unread: 0,
      createdAt: baseNow - 70 * 60 * 1000,
      departInMin: 0,
    },
    {
      id: "mock_sin_mensajes_1",
      kind: "reservaste",
      otherUserId: "sofia",
      status: "activa",
      lastMessage: "",
      unread: 0,
      createdAt: baseNow - 2 * 60 * 1000,
      departInMin: 10,
    },
  ];
